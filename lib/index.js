...
var Sdk = /** @class */ (function () {
    function Sdk(url) {
        ...
        this.groups = function () {
            return fetch(_this.url + "/api/v1/groups", {
                headers: _this.createHeaders(_this.token),
                mode: _this.createMode(),
            }).then(function (res) { return _this.resHandler(res); });
        };
        ...
        this.sensors = function (groupId) { return fetch(_this.url + "/api/v1/groups/" + groupId + "/sensors", {
            headers: _this.createHeaders(_this.token),
            mode: _this.createMode(),
        }).then(function (res) { return _this.resHandler(res); }); };
        ...
        this.issues = function (groupId, stat) {
            return fetch(_this.url + "/api/v1/groups/" + groupId + "/issues?status=" + stat, {
                headers: _this.createHeaders(_this.token),
                mode: _this.createMode(),
            }).then(function (res) { return _this.resHandler(res); });
        };
        ...
        this.viewsByTeam = function (teamId) { return fetch(_this.url + "/api/v1/views/" + teamId + "/views", {
            headers: _this.createHeaders(_this.token),
            mode: _this.createMode(),
        }).then(function (res) { return _this.resHandler(res); }); };
